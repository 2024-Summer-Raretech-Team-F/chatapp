...
INSERT INTO users (user_kanji_full, user_kana_full, parent_name, email, password, role, phone_number, academic_level_id, school_id)VALUES('五条　悟', 'ゴジョウ　サトル', '五条　由紀子','satoru@example.com', '011f55b984b0ea1e5e1d6a32df1ac1548fe24f8c20d85012b04c6fc5139abb42', 'student', '090-1234-5678', 1, 1);
INSERT INTO users (user_kanji_full, user_kana_full, parent_name, email, password, role, phone_number, academic_level_id, school_id)VALUES('夏油　傑', 'ゲトウ　スグル' NULL,'suguru@example.com', '54aaa3aced18c8f91fa47b375ea186680236a0359f80dcf483ad7b90b72f8d0d', 'teacher', '080-8765-4321', 1, 1);
INSERT INTO users (user_kanji_full, user_kana_full, parent_name, email, password, role, phone_number, academic_level_id, school_id)VALUES('家入　硝子', 'イエイリ　ショウコ', NULL, ,'syouko@example.com', 'ade7c829d3edab5cdb685fa383149fa867d0880136341ecfe1e1128dc9e2dfdd', 'teacher', '080-4321-8765', 1, 1);
